...
export function dynamicDelete(id) {
  return ajax(api.dynamicdelete, {
    id: id
  }, 'POST')
}
//收藏文章
export function collectSave(id) {
  return ajax(api.collectsave, {
    contentId: id
  }, 'POST')
}
//取消收藏
export function collectDel(id) {
  return ajax(api.collectdelete, {
    id: id
  }, 'POST')
}
//收藏列表
