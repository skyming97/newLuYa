    ...
    <div>
        ...
        <el-container >
            <el-main class="expand">
                ...
                <el-dialog title="接口编辑" :visible.sync="dialogFormVisible" width="40%" modal-append-to-body>
...
import {menuList,menuSave,menuUpdate,menuDelete} from '@/api/apiconfig'
        ...
        getapilist(){//获取页面列表
            menuList().then(res=>{
                ...
                for(let i in data){
                    ...
                    if(data[i].level == 1 && data[i].pId ==0 ){
