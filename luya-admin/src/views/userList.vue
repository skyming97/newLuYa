  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      let data = { currentPage: val, pageSize: this.pageSize };
            if (this.search.nickName) data.nickName = this.search.nickName;
      
      if (this.search.address)  data.address = this.search.address;
    ...
    Export() {
      ...
      let downloadUrl =
        userexport + "?token_=" + token_ + "&check_code=" + check_code;
