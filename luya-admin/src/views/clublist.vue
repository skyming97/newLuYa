            ...
            <el-main>
                <el-row>
                    <el-col class="searchInp" >
                        <span>姓名：</span>
                        <el-input size="mini" v-model="search.name" class="searchInput" clearable placeholder="姓名查询"></el-input>
                        <span>电话：</span>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-table :data="shoplist" style="width: 100%" class="box" ref="filterTable">
                        ...
                        <el-table-column prop="wxh" label="微信号" width="150" align="center"></el-table-column>
                        ...
                        <el-table-column prop="createTime" label="申请时间" width="200" align="center"></el-table-column>
                        <el-table-column prop="vipcode" label="会员码" width="200" align="center"></el-table-column>
